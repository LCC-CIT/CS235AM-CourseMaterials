...
namespace Xamarin.WebServicesAsync.Soap.iOS.RxNav {
    ...
    [System.Xml.Serialization.SoapInclude(typeof(RxNode))]
    ...
    public partial class DBManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public void getClassHierarchyAsync(string rxcui, string sab, string type, int oneLevel) {
            this.getClassHierarchyAsync(rxcui, sab, type, oneLevel, null);
        }
        
        public void getClassHierarchyAsync(string rxcui, string sab, string type, int oneLevel, object userState) {
