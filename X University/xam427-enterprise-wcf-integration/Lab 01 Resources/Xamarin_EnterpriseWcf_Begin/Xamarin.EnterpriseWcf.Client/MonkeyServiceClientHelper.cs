...
namespace Xamarin.EnterpriseWcf.Client
{
    public static class MonkeyServiceClientHelper
    {
        ...
        //#if DEBUG
        //        private static readonly EndpointAddress ServiceEndPoint = new EndpointAddress("http://localhost:2116/MonkeyService.svc");
        //#else
        //private static readonly EndpointAddress ServiceEndPoint = new EndpointAddress("http://prodaddress/MonkeyService.svc");
        //#endif
