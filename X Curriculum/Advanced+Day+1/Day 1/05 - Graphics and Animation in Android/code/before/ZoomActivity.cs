namespace com.xamarin.evolve2013.animationsdemo
{
    ...
    /// <summary>
    ///   This activity is a bonus example of animation using the ObjectAnimator.
    /// </summary>
    ...
    public class ZoomActivity : Activity
    {
        ...
        /// </summary>
        /// <param name="view">This is the view that we want</param>
        ...
        /// <returns></returns>
        private AnimatorSet BuildExpandingAnimatorSet(View view, Rect startBounds, Rect finalBounds, float startScale)
        {
            AnimatorSet expandSet = new AnimatorSet();
            expandSet.Play(ObjectAnimator.OfFloat(view, View.X, startBounds.Left, finalBounds.Left))
                     .With(ObjectAnimator.OfFloat(view, View.Y, startBounds.Top, finalBounds.Top))
                     .With(ObjectAnimator.OfFloat(view, "ScaleX", startScale, 1f))
                     .With(ObjectAnimator.OfFloat(view, "ScaleY", startScale, 1f));
            expandSet.SetDuration(_shortAnimationDuration);
            expandSet.SetInterpolator(new DecelerateInterpolator());
            expandSet.AnimationEnd += (o, args) => { _currentAnimator = null; };
            expandSet.AnimationCancel += (o, args) => { _currentAnimator = null; };
            return expandSet;
        }
