...
namespace EvolveListView {
	...
	/// </summary>
	[Activity (Label = "ListView2", MainLauncher = true, Icon="@drawable/ic_launcher")]			
	public class SpeakersActivity : ListActivity {
		private List<Speaker> speakers;

		//TODO: Demo2: uncomment this so we can assign it below
//		SpeakersAdapter adapter;
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			//TODO: Demo2: delete this old code
			var items = new string[] { "Miguel de Icaza", "Nat Friedman", "Bart Decrem", "Scott Hanselman" };
			ListAdapter = new ArrayAdapter<String>(this, Android.Resource.Layout.SimpleListItem1, items);

			//TODO: Demo2: uncomment this to use the hardcoded data below, and the custom adapter
...
//			ListView.Adapter = adapter;
		...
		{
			// this only works after the Demo2 code has been uncommented above
			var t = speakers[position].Name;
