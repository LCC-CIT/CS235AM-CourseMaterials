...
namespace EvolveListView
{
	...
	/// Demo 3: Row styles
	/// </summary>
	[Activity (Label = "ListView3", MainLauncher = true, Icon="@drawable/ic_launcher")]			
	public class Speakers3Activity : ListActivity
	{
		private Speakers3Adapter adapter;
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			adapter = new Speakers3Adapter(this, speakers);
