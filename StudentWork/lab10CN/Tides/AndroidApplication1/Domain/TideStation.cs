...
namespace Domain
{
	...
	public class TideStation
	{
		public TideStation ()
		{
			...
			// units=english&time_zone=gmt&application=ports_screen&format=json 
			Address = "http://tidesandcurrents.noaa.gov/noaatidepredictions/NOAATidesFacade.jsp?Stationid=";
		}
