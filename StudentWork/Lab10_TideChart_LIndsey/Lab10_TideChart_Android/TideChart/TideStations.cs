...
namespace TideChart
{
	...
	public class TideInfo
	{
		...
		{
			return string.Format ("{0}, Ft = {1}, Cm = {2}, {3}", Time, PredictionInFt, PredictionInCm, HighLow);
		}
	}
	#endregion
	...
	public class TideStations
	{
		...
		public TideStations ()
		{
			...
			{
				string error = "Error:";
				//get list of stations from Webservice
				try
				{
					...
					_Stations = new List<StationInfo> ();
					_Stations.Add (new StationInfo(error,12));
				}
			}
		}
